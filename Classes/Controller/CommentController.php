...
class CommentController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * commentRepository
     *
     * @var \Dawin\ChSbBlog\Domain\Repository\CommentRepository
     * @inject
     */
     ...
     * action create
     *
     * @param \Dawin\ChSbBlog\Domain\Model\Comment $newComment
     * @return void
     */
    public function createAction(\Dawin\ChSbBlog\Domain\Model\Comment $newComment)
    {
